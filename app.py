...
# st.title("GenAI Green Genie 💹🌱")
# st.subheader("AI-driven Personalized Investment Recommendations")
...
#         # Styled dataframe (stretch to container width)
#         if "ESG Score" in recs_display.columns:
#             try:
#                 styled = recs_display.style.background_gradient(cmap="Greens", subset=["ESG Score"]).format({"ESG Score": "{:.0f}"})
...
#                 text="ESG Score"
#             )
#             fig.update_layout(xaxis_title="", yaxis_title="ESG Score")
#             fig.update_traces(textposition="outside")
#             st.plotly_chart(fig, width="stretch")

#         # Download CSV (stretch)
#         csv_bytes = recs_display.to_csv(index=False).encode("utf-8")
#         st.download_button(
